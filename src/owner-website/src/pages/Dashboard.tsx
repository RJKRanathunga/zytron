    ...
    <div className="page">
      <section className="heading">
        ...
        <div className="heading-actions">
          ...
          <button className="btn primary" type="button" onClick={() => navigate('/offers')}>
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <button className="btn ghost" type="button" onClick={() => navigate('/offers')}>
              Compare offers
            </button>
          </div>
      ...
      <section className="grid-main">
        ...
        <article className="panel">
          <div className="panel-heading">
            ...
            <button className="text-btn" type="button" onClick={() => navigate('/offers')}>
              View all
            </button>
          </div>
      ...
      <section className="grid-equal">
        ...
        <article className="impact-card">
          ...
          <button className="btn light" type="button" onClick={() => navigate('/impact')}>
            Explore impact
          </button>
        </article>
      </section>
