...
const navGroups = [
  {
    label: 'Manage',
    items: [
      { to: '/', icon: 'H', label: 'Overview', end: true },
      { to: '/bins', icon: 'B', label: 'My smart bins', badge: 'bins' },
      { to: '/collection-points', icon: 'P', label: 'Collection points' },
      { to: '/lots', icon: 'L', label: 'Plastic lots' },
      { to: '/offers', icon: 'O', label: 'Collector offers', badge: 'offers' },
      { to: '/pickups', icon: 'U', label: 'Scheduled pickups', badge: 'pickups' },
    ],
  },
  {
    label: 'Value',
    items: [
      ...
      { to: '/impact', icon: 'I', label: 'Impact & community' },
      { to: '/messages', icon: 'C', label: 'Messages', badge: 'messages' },
    ],
  },
  {
    label: 'Account',
    items: [
      { to: '/profile', icon: 'A', label: 'Owner profile' },
      { to: '/settings', icon: 'S', label: 'Point settings' },
    ],
  },
]
