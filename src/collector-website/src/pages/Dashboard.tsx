    ...
    <div className="page">
      <section className="heading">
        ...
        <div className="heading-actions">
          <button className="btn secondary" type="button" onClick={() => navigate('/demand-alerts')}>
            Demand alerts
          </button>
          <button className="btn primary" type="button" onClick={() => navigate('/marketplace')}>
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <button className="btn ghost" type="button" onClick={() => navigate('/marketplace?material=PP')}>
              View matching lots
            </button>
          </div>
      ...
      <section className="grid-equal">
        ...
        <article className="panel">
          <div className="panel-heading">
            ...
            <button className="text-btn" type="button" onClick={() => navigate('/demand-alerts')}>
              Manage alerts
            </button>
          </div>
      ...
      <section className="grid-equal">
        <article className="panel">
          <div className="panel-heading">
            ...
            <button className="text-btn" type="button" onClick={() => navigate('/pickups')}>
              Full schedule
            </button>
          </div>
        ...
        <article className="panel">
          <div className="panel-heading">
            ...
            <button className="text-btn" type="button" onClick={() => navigate('/collection-points')}>
              View partners
            </button>
          </div>
