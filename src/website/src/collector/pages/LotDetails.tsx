...
export function LotDetails() {
  ...
  if (!lot) return <Navigate to="/collector/marketplace" replace />
    ...
    <div className="page">
      <section className="heading">
        ...
        <div className="heading-actions">
          <button className="btn secondary" type="button" onClick={() => navigate('/collector/marketplace')}>
            Back to lots
          </button>
      ...
      <section className="detail-grid">
        ...
        <SupplyMap
          ...
          onSelectLot={(nextLotId) => navigate(`/collector/marketplace/${nextLotId}`)}
